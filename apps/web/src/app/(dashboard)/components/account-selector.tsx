  ...
  if (!loading && accounts.length === 0) {
    return (
      <Link
        ...
        className="flex items-center gap-2 px-3 py-1.5 rounded-lg text-xs text-[var(--accent-blue)] bg-[var(--bg-tertiary)] border border-[var(--border-primary)] hover:bg-[var(--bg-hover)] transition-colors min-h-[44px]"
      >
  ...
  return (
    <div ref={ref} className="relative">
      ...
      <button
        ...
        className="flex items-center gap-2 px-3 py-1.5 rounded-lg text-xs bg-[var(--bg-tertiary)] border border-[var(--border-primary)] hover:bg-[var(--bg-hover)] transition-colors max-w-[200px] min-h-[44px]"
        aria-expanded={open}
